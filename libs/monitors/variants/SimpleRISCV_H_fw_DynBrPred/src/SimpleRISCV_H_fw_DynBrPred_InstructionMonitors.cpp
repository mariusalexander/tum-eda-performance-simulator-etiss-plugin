...
static InstructionMonitor *instrMonitor_beq = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "SimpleRISCV_H_fw_DynBrPred_Monitor_brTarget_buffer[*SimpleRISCV_H_fw_DynBrPred_Monitor_instrCnt] = " << ic.current_address_ + (((int16_t)(imm  << 3)) >> 3) << ";\n";
...
static InstructionMonitor *instrMonitor_cbeqz = new InstructionMonitor(
  ...
  [](etiss::instr::BitArray &ba, etiss::instr::Instruction &instr, etiss::instr::InstructionContext &ic){
    ...
    ret_strs << "SimpleRISCV_H_fw_DynBrPred_Monitor_brTarget_buffer[*SimpleRISCV_H_fw_DynBrPred_Monitor_instrCnt] = " << ic.current_address_ + (((int16_t)(imm  << 7)) >> 7) << ";\n";
