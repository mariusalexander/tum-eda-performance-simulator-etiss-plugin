...
AssemblyTrace_RV32_Monitor::AssemblyTrace_RV32_Monitor(): Monitor("AssemblyTrace_RV32_Monitor", AssemblyTrace_RV32_InstrMonitorSet)
{}

void AssemblyTrace_RV32_Monitor::connectChannel(Channel* channel_)
{
  Monitor::connectChannel(channel_);

  AssemblyTrace_RV32_Monitor_instrCnt = &(channel_->instrCnt);
...
std::string AssemblyTrace_RV32_Monitor::getBlockDeclarations(void) const
{
  std::stringstream ret_strs;
  ret_strs << "#include <string.h>\n";
 
  ret_strs << "extern uint64_t *AssemblyTrace_RV32_Monitor_instrCnt;\n";
